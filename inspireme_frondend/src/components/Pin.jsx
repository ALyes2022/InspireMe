            ...
            <div className='flex justify-between items-center gap-2 w-full'>
              {destination && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='bg-white flex items-center gap-2 text-black font-blod p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md'
                >
              ...
              {postedBy?._id === user.sub && (
                <button
                  className='bg-white p-2 opacity-70 hover:opacity-100 text-dark font-bold text-base rounded-3xl shadow-md outline-none'
                  type='button'
                  onClick={
                    (event) => {
                      event.stopPropagation();
